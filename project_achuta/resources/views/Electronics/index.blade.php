 ...
 <main class="mt-20 pb-16">
        ...
        <section class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Électronique & High-Tech</h1>
                    <p class="text-gray-600 mt-2">Découvrez nos derniers gadgets et appareils innovants</p>
                </div>
            ...
            <div class="flex overflow-x-auto gap-2 py-4 scrollbar-hide">
                ...
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">Casques Audio</button>
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">Montres Connectées</button>
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">Smartphones</button>
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">Réfrigérateurs</button>
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">Gaming</button>
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">Accessoires PC</button>
            </div>
        </section>
