   ...
   <main class="mt-20 pb-16">
        ...
        <section class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Livres & Divertissements</h1>
                    <p class="text-gray-600 mt-2">
                        Plongez dans des univers captivants avec notre sélection de livres, jeux et loisirs culturels.
                    </p>
                </div>
                        ...
                        <ul class="splide__list">
                            ...
                            <li class="splide__slide">
                                <div class="relative rounded-xl overflow-hidden h-80">
                                    ...
                                    <div
                                        class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6 rounded-b-xl">
                                        <h3 class="text-white font-bold text-xl">Style Aricain</h3>
                                        <p class="text-white/80 mt-1">Découvrez notre collection</p>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="splide__slide">
                                <div class="relative rounded-xl overflow-hidden h-80">
                                    ...
                                    <div
                                        class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6 rounded-b-xl">
                                        <h3 class="text-white font-bold text-xl">Style Americain</h3>
                                        <p class="text-white/80 mt-1">Découvrez notre la collection americaine</p>
                                    </div>
                                </div>
                            </li>
            ...
            <!-- Filtres rapides pour articles électroniques et électroménagers -->
            <div class="flex overflow-x-auto gap-2 py-4 scrollbar-hide">
                <!-- Bouton "Tous" mis en avant -->
                <button class="px-4 py-2 bg-[#008751] text-white rounded-full whitespace-nowrap">Tous</button>
                
                <!-- Catégories spécifiques aux livres/divertissements -->
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">Romans</button>
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">BD & Mangas</button>
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">Jeux de société</button>
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">Livres jeunesse</button>
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">Puzzles</button>
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">Cadeaux créatifs</button>
            </div>
        </section>
        ...
        <section class="container mx-auto px-4 mt-10">
            <div class="flex justify-between items-center mb-6">
                <h2 class="md:text-2xl text-lg font-bold">Articles disponibles</h2>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-6">
                <!--Article 1-->
                <div
                    class="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition border border-gray-100 h-full flex flex-col">

                    <div class="relative flex-shrink-0">
                        <img class="w-full h-40 sm:h-48 object-cover"
                            src="./assets/articles/still-life-spring-wardrobe-switch.jpg" alt="Sac à main">
                        <button
                            class="absolute top-2 right-2 sm:top-3 sm:right-3 bg-white/80 rounded-full p-1.5 sm:p-2 backdrop-blur-sm hover:scale-110 transition-all">
                            <i class="far fa-heart text-gray-600 hover:text-[#E8112D] text-sm sm:text-base"></i>
                        </button>
                        <span
                            class="absolute top-2 left-2 sm:top-3 sm:left-3 bg-gradient-to-r from-[#FF6B00] to-[#FF8F00] text-white text-[10px] text-xs px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full font-bold shadow-md flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-2.5 w-2.5 sm:h-3 sm:w-3 mr-0.5 sm:mr-1"
                    ...
                    <div class="p-3 sm:p-4 flex-grow flex flex-col">
                        <div class="flex justify-between items-start mb-1 sm:mb-2">
                            <h3 class="font-bold text-gray-900 text-xs md:text-base line-clamp-2">Sac à main cuir
                                véritable</h3>
                            <div class="flex flex-col items-end">
                                ...
                                <span
                                    class="mt-0.5 sm:mt-1 bg-green-100 text-green-800 text-[10px] sm:text-xs px-1 sm:px-1.5 py-0.5 rounded-full">-30%</span>
                            </div>
                        </div>
                        <span
                            class="inline-block bg-blue-100 text-blue-800 text-[10px] sm:text-xs px-1.5 sm:px-2 py-0.5 sm:py-1 rounded mb-1 sm:mb-2">Neuf
                            avec étiquette</span>

                        <div class="flex flex-wrap gap-1 mt-1 sm:mt-2">
                            <span
                                class="text-[10px] sm:text-xs bg-gray-100 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded">S</span>
                            <span
                                class="text-[10px] sm:text-xs bg-gray-100 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded">M</span>
                            <span
                                class="text-[10px] sm:text-xs bg-gray-100 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded">L</span>
                            <span
                                class="text-[10px] sm:text-xs bg-gray-100 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded">XL</span>
                        </div>
                        ...
                        <div class="flex justify-between items-center mt-2 sm:mt-3">
                            <div class="flex items-center">
                                <i
                                    class="fas fa-map-marker-alt text-gray-400 text-[10px] sm:text-xs mr-1 sm:mr-1.5"></i>
                            ...
                            <div class="flex items-center text-green-600 text-[10px] sm:text-xs">
                                <span
                                    class="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-green-500 rounded-full mr-1 sm:mr-1.5 animate-pulse"></span>
                                En ligne
                            </div>
                        </div>
