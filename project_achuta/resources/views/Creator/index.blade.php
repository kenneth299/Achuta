    ...
    <main class="mt-20 pb-16">
        ...
        <section class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Créateurs Passionnés, Pièces Uniques</h1>
                    <p class="text-gray-600 mt-2">Découvrez des créations qui racontent une histoire. Des vêtements aux
                        accessoires.</p>
                </div>
                <div class="relative w-full md:w-auto">
                    ...
                    <ul id="sortMenu" class="absolute right-0 mt-2 bg-white border rounded-md shadow-md w-48 hidden z-10">
            ...
            <div class="flex overflow-x-auto gap-2 py-4 scrollbar-hide">
                ...
                <button class="px-4 py-2 bg-gray-100 rounded-full whitespace-nowrap hover:bg-gray-200 transition">Bracelet</button>
            </div>
        </section>
        ...
        <section class="container mx-auto px-4 mt-10">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-6">
                <!-- Article 1 -->
                <div class="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition border border-gray-100 h-full flex flex-col">
                    ...
                    <div class="p-3 sm:p-4 flex-grow flex flex-col">
                       ...
                       <div class="w-full h-auto flex flex-col sm:flex-row items-center justify-between mt-2 gap-3">
    <!-- Bouton WhatsApp -->
    <a href="https://wa.me/33612345678?text=Je%20suis%20intéressé%20par%20votre%20sac%20à%20main"
        class="w-full sm:w-auto p-2 rounded-md text-[10px] sm:text-xs text-white flex items-center justify-center bg-[#008751] hover:bg-[#128C7E] transition">
        <i class="fab fa-whatsapp mr-1 sm:mr-2 text-xs sm:text-sm"></i> Commander
    </a>
    
    <!-- Bouton "Voir" -->
    <button class="w-full sm:w-auto p-2 text-xs rounded-md text-gray-900 border-gray-900 border flex items-center justify-center hover:text-white bg-transparent hover:bg-gray-900 transition">
        <i class="far fa-eye text-xs mr-1 sm:mr-0"></i>
        <span class="sm:hidden">Voir</span> <!-- Texte visible uniquement sur mobile -->
    </button>
</div>
                    </div>
                </div>
