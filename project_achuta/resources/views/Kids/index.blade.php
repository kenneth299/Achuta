 ...
 <main class="mt-20 pb-16">
        ...
        <section class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Univers Enfants</h1>
                    <p class="text-gray-600 mt-2">Parce que grandir est une aventure, offrez-leur des articles aussi uniques qu’eux.</p>
                </div>
